...
tf.app.flags.DEFINE_string('save_path','../data/samples/',"directory which save results")
tf.app.flags.DEFINE_string('postive','../data/samples/postive/',"directory which save postive samples")
tf.app.flags.DEFINE_string('negtive','../data/samples/negtive/',"directory which save negtive samples")
